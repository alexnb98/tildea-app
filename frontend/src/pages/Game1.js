...
const colorError = "incorrect"; //not implemented yet
const colorSuccess = "correct"; //not implemented yet
        ...
        return (
            <div className="bg-light text-center py-5">
                <div className="container py-5">
                    <h1>
                        <span className="h1 font-weight-light">{gameTitle}</span>
                    </h1>
                    ...
                    {!isGameFinished ? (
                        <Score score={progress} mistakes={errors} wordsRemaining={words.length - progress} />
                    ) : null}
                </div>
            </div>
        );
